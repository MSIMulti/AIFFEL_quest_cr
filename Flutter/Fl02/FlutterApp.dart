...
// 회고 : 프론트엔드단에서 필요한 사용자 인터페이스 구현 및 위젯 배치에 대해 알 수 있었으며, 특별한 아이콘을 추가하거나 버튼의 모양을 변경하는 등의 추가 작업은 ChatGPT의 도움이 필요했습니다.
// 　　　　특히 컨테이너를 중첩하는 과정과 위치 지정 그리고 앱바에 대한 어려움이 있었는데 교재 및 GPT의 도움으로 해결할 수 있었습니다.
